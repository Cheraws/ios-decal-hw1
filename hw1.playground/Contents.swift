...
//: No. ! means that it must be of a string type.
...
//: It should be a class func. That is why the code wasn't working.
...
//: We never initialized countLetters. Also, a bunch of things could be changed with let instead of var.
